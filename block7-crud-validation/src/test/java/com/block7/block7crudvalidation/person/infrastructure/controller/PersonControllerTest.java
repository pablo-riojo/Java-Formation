...
class PersonControllerTest {
    ...
    void getPersonById() throws Exception {
        UUID id = repository.save(person).getId();
    ...
    void getPersonByUser() throws Exception {
        String user = repository.save(person).getUser();
    ...
    void getPersonByName() throws Exception {
        String name = personInputDTO.getName();
    ...
    void getPersonBySurname() throws Exception {
        String surname = personInputDTO.getSurname();
